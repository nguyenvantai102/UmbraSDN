...
class CLIRunner:
    ...
    async def start(self):
        ...
        logger.info(f"Message_start: {messages}")
        return ack, messages
    ...
    async def stop(self):
        ...
        logger.info(f"Message_stop: {messages}")
        return messages
    ...
    async def install(self):
        ...
        logger.info(f"Message_install: {messages}")
        return ack, messages
    ...
    async def uninstall(self):
        ...
        logger.info(f"Message_uninstall: {messages}")
        return messages
    ...
    async def begin(self):
        ...
        logger.info(f"Message_begin: {messages}")
        return ack, messages
    ...
    async def end(self):
        ...
        logger.info(f"Message_end: {messages}")
        return ack, messages
